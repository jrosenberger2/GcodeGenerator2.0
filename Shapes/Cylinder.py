...
#Cylinder creation and scaling
x, y, z = Decimal(sys.argv[4]), Decimal(sys.argv[5]),  Decimal(sys.argv[6])  
bpy.ops.mesh.primitive_cylinder_add(radius=1.0, end_fill_type='TRIFAN', depth=2.0,scale=(x/Decimal(2.0), y/Decimal(2.0), z/Decimal(2.0)))

#Export method with every arg listed for debugging
bpy.ops.export_scene.gltf(filepath='Models\\Cylinder.glb',
